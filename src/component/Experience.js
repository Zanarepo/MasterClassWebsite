...
export default function AboutMe() {
  return (
    ...
    <h2 className="text-3xl font-semibold text-blue-800 mb-6 text-center">About Me</h2>
    
    <div className="space-y-6">
      {/* Experience Overview */}
      <div className="bg-gray-50 w-full rounded-lg shadow-md p-4">
      ...
      {/* Mentorship */}
      <div className="bg-gray-50 w-full rounded-lg shadow-md flex items-center p-4">
      ...
      {/* Certification */}
      <div className="bg-gray-50 w-full rounded-lg shadow-md flex items-center p-4">
        <FaCertificate className="text-blue-800 text-3xl mr-4" />
        <p className="text-lg text-gray-800">
